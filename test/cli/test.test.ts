...
describe('test CLI', () => {
  ...
  describe('help command', () => {
    it('should display help when no command provided', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('Test Generation & Coverage Tracking'),
      )
  ...
  describe('generate command', () => {
    ...
    it('should handle custom framework', async () => {
      ...
      expect(TestGenerator).toHaveBeenCalledWith(
        expect.objectContaining({
          framework: 'jest',
        }),
      )
  ...
  describe('coverage command', () => {
    ...
    it('should show recommendations', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('Statement coverage is low'),
      )
    })
  ...
  describe('trends command', () => {
    it('should show coverage trends', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('Coverage Trends (last 30 days)'),
      )
    ...
    it('should show trend direction', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('Trend: 📈 +5.0% lines coverage'),
      )
    })
    ...
    it('should handle no trend data', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        'Run "coda test coverage" to start tracking coverage.',
      )
    })
  })
  ...
  describe('recommend command', () => {
    it('should show test recommendations', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining('Statement coverage is 70%'),
      )
    })
