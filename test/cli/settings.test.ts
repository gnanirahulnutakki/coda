...
describe('handleSettingsCommand', () => {
  ...
  describe('help command', () => {
    it('should display help when no command provided', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('Settings Import/Export Management'))
    })
  ...
  describe('export command', () => {
    it('should export settings bundle', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('✅ Settings exported successfully'))
    })
    ...
    it('should handle export errors', async () => {
      ...
      expect(mockConsoleError).toHaveBeenCalledWith(expect.stringContaining('❌ Failed to export settings'))
    })
  })
  ...
  describe('import command', () => {
    it('should import settings bundle', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('✅ Settings imported successfully'))
    })
    ...
    it('should handle import errors', async () => {
      ...
      expect(mockConsoleError).toHaveBeenCalledWith(expect.stringContaining('❌ Failed to import settings'))
    })
    ...
    it('should show import errors and warnings', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('⚠️  Import completed with errors:'))
    })
  })
  ...
  describe('validate command', () => {
    ...
    it('should show validation errors', async () => {
      ...
      expect(mockConsoleError).toHaveBeenCalledWith(expect.stringContaining('❌ Bundle validation failed'))
      expect(mockConsoleError).toHaveBeenCalledWith(expect.stringContaining('Missing version field'))
    })
  ...
  describe('backup command', () => {
    it('should create backup', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('✅ Backup created successfully'))
    })
    ...
    it('should handle backup errors', async () => {
      ...
      expect(mockConsoleError).toHaveBeenCalledWith(expect.stringContaining('❌ Failed to create backup'))
    })
  })
  ...
  describe('restore command', () => {
    it('should restore from backup', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('✅ Restore completed successfully'))
    })
    ...
    it('should handle restore errors', async () => {
      ...
      expect(mockConsoleError).toHaveBeenCalledWith(expect.stringContaining('❌ Failed to restore backup'))
    })
  })
  ...
  describe('info command', () => {
    ...
    it('should handle info errors', async () => {
      ...
      expect(mockConsoleError).toHaveBeenCalledWith(expect.stringContaining('❌ Failed to get backup info'))
    })
  })
