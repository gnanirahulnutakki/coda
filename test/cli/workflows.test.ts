...
describe('workflows CLI', () => {
  ...
  describe('list command', () => {
    ...
    it('should list templates filtered by category', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining("Templates in category 'testing'"))
    })
  ...
  describe('run command', () => {
    ...
    it('should run workflow with interactive prompts', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('Running Workflow: Test Template'))
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('Execution ID: exec-123'))
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('Do test-action on default.js'))
    })
  ...
  describe('create command', () => {
    it('should create template interactively', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('Template created successfully'))
    })
  })
  ...
  describe('delete command', () => {
    it('should delete template', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith("✓ Template 'custom-template' deleted successfully")
    })
  ...
  describe('export command', () => {
    ...
    it('should require template ID and output file', async () => {
      await expect(handleWorkflowCommand(['export', 'test-template'])).rejects.toThrow('process.exit')
  ...
  describe('import command', () => {
    it('should import template from file', async () => {
      ...
      expect(mockManager.importTemplate).toHaveBeenCalledWith('id: imported\nname: Imported Template')
    ...
    it('should handle missing file', async () => {
      ...
      await expect(handleWorkflowCommand(['import', 'missing.yaml'])).rejects.toThrow('process.exit')
  ...
  describe('history command', () => {
    it('should show recent executions', async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(expect.stringContaining('Recent Workflow Executions'))
