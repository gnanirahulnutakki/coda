...
describe('handleWizardCommand', () => {
  ...
  describe('wizard execution', () => {
    it('should run wizard with defaults', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('✅ Configuration saved to:'))
    ...
    it('should run wizard with preset', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('📦 Based on preset: minimal'))
    })
    ...
    it('should save to custom path', async () => {
      ...
      expect(mockWizard.saveConfig).toHaveBeenCalledWith(
        expect.any(Object),
        '/custom/config.yaml'
      )
      
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('✅ Configuration saved to: /custom/config.yaml'))
    })
  ...
  describe('recommendation mode', () => {
    it('should show recommendations when --recommend is provided', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('🎯 Let me help you find the right configuration preset!'))
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('What is your experience level'))
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('✨ Based on your preferences'))
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('Use: coda wizard --preset'))
    ...
    it('should show tip about browsing all presets', async () => {
      ...
      expect(mockConsoleLog).toHaveBeenCalledWith(expect.stringContaining('💡 Tip: You can also browse all presets with: coda preset list'))
    })
  })
