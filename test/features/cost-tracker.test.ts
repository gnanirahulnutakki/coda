...
describe('CostTracker', () => {
  ...
  describe('recordUsage', () => {
    it('should record usage session with cost calculation', () => {
      ...
      const sessionId = costTracker.recordUsage(
        'claude-code',
        usage,
        {},
  ...
  describe('cost limits', () => {
    ...
    it('should merge partial limits with existing ones', () => {
      costTracker.setLimits({ daily: 10.0, currency: 'USD' })
      costTracker.setLimits({ weekly: 50.0 })
    ...
    it('should check limit status correctly', () => {
      ...
      vi.spyOn(costTracker, 'getDailyCost').mockReturnValue(8.5)
      vi.spyOn(costTracker, 'getCostSince').mockReturnValueOnce(45.0).mockReturnValueOnce(180.0)
    ...
    it('should warn when limits are exceeded', () => {
      ...
      costTracker.setLimits({ daily: 5.0, currency: 'USD' })

      // Mock getDailyCost to return a value exceeding the limit
      vi.spyOn(costTracker, 'getDailyCost').mockReturnValue(6.0)
      ...
      expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining('Daily cost limit exceeded'))
  ...
  describe('exportData', () => {
    it('should export usage data to file', () => {
      ...
      const mockSessions = [{ id: '1', timestamp: '2024-01-01T10:00:00Z', provider: 'claude-code' }]
      const mockSummaries = [{ date: '2024-01-01', totalCost: 10.5 }]
  ...
  describe('getTopExpensiveCommands', () => {
    ...
    it('should handle sessions without commands', () => {
      const mockSessions = [
        { command: 'test', provider: 'claude-code', cost: { totalCost: 5.0 } },
        { provider: 'claude-code', cost: { totalCost: 10.0 } }, // No command
      ]
